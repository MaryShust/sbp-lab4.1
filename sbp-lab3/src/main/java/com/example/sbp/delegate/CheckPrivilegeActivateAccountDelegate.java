...
@Component
@Slf4j
public class CheckPrivilegeActivateAccountDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        if (userName != null &&
                privileges.contains(Privilege.ACCOUNT_ACTIVATE) &&
        ...
        execution.setVariable("bpmnErrorMessage", "Недостаточно прав для активации аккаунта");
    }
}