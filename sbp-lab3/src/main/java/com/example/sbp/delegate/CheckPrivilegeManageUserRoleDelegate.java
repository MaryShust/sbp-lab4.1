...
@Component
@Slf4j
public class CheckPrivilegeManageUserRoleDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        if (userName != null && privileges.contains(Privilege.USER_MANAGE_ROLES)) {
        ...
        execution.setVariable("bpmnErrorMessage", "Недостаточно прав для управления ролями пользователя");
    }
}